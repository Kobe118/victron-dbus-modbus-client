...
class Eastron_SDM630(device.EnergyMeter,device.CustomName):
    ...
    def __init__(self, *args):
        super(Eastron_SDM630, self).__init__(*args)
        self.timeout = Eastron_SDM630.min_timeout
        self.restart_timeout = 120 # if the grid meter is lost for more than 120s, restart the service.
    ...
    def device_init_late(self): 
        ...
        self.dbus.add_path('/DeviceName','Eastron SDM630')
        self.dbus.add_path('/NrOfPhases',3)
        self.dbus.add_path('/Ac/L1/Energy/Consumption',0,writeable=True)
        self.dbus.add_path('/Ac/L2/Energy/Consumption',0,writeable=True)
        self.dbus.add_path('/Ac/L3/Energy/Consumption',0,writeable=True)
    ...
    def phase_regs(self, n):
        ...
        return [
            ...
            Reg_f32b(0x015a + s, '/Ac/L%d/Energy/Forward' % n, 1, '%.1f kWh', max_age=15),
            Reg_f32b(0x0160 + s, '/Ac/L%d/Energy/Reverse' % n, 1, '%.1f kWh', max_age=15),
        ]
    ...
    def device_init(self):
        ...
        regs = [
            ...
            Reg_f32b(0x0034, '/Ac/Power',          1, '%.1f W', max_age=0.28),

            Reg_f32b(0x0038, '/Ac/ApparentPower',  1, '%.1f VA', max_age=5),
            Reg_f32b(0x003c, '/Ac/ReactivePower',  1, '%.1f VAr', max_age=5),
            Reg_f32b(0x003e, '/Ac/PowerFactor',    1, '%.1f', max_age=5),
